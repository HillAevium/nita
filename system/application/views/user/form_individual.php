...
<div class="header_bar_blue_full">
    <table class="header">
        <tr>
            <td style="width:484px;" class="pad">Billing Address</td>
    ...
    <tr>
        ...
        <td style="width:448px;">
            <table>
                ...
                <tr>
                    <td colspan="2">
                        <input name="shippingAddress2" class="large" />
                    </td>
                </tr>
                <tr>
                    <td style="width:242px;">
...
<div class="header_bar_blue_full">
    <table class="header">
        <tr>
            <td style="width:484px;" class="pad">Extra Information</td>
            <td>&nbsp;</td>
        </tr>
    </table>
</div>
    ...
    <tr>
        <td style="width:493px;">
            <table style="width:449px;">
                ...
                <tr>
                    <td colspan="2">
                        <label>Will you be attending NITA classes?</label>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
